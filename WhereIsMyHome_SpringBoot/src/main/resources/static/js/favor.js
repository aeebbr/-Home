...
const handleClickAddRegion = () => {
	...
	location.href = `/whereismyhome_be/favor?act=insert&sidoCode=${sidoCode}&gugunCode=${gugunCode}&dongCode=${dongCode}&sidoName=${sidoName}&gugunName=${gugunName}&dongName=${dongName}`;
};
